...
#FRIENDSHIPS FIRST PART
    ...
    # excepted = ['Daniel ','Michael']
    # users = models.Users.objects.all() & models.Users.objects.exclude(first_name__in=excepted)
    ...
    # users = models.Users.objects.filter(last_name="Rodriguez")
    # users = models.Users.objects.exclude(last_name="Rodriguez")
    # users = models.Users.objects.filter(id__gte=9) | models.Users.objects.exclude(id__lte=11)
    # users = models.Users.objects.filter(last_name="Rodriguez") | models.Users.objects.filter(first_name="Daniel")
    ...
    # context = {'user':user}
    ### This will NOT work "get() returned more than one Users -- it returned 3!"
    # users = models.Users.objects.get(last_name="Rodriguez")
    ###
    ### This will NOT work "Users matching query does not exist."
    # users = models.Users.objects.get(id=10000)
    ###
    # users = models.Users.objects.order_by('-last_name')
    # # friendships = models.Friendships.objects.filter(friend=4)
    # friendships = models.Friendships.objects.filter(user__gt=6) | models.Friendships.objects.filter(user__lt=4)
    # print friendships
    #
    # context = {
    #     'users':users,
